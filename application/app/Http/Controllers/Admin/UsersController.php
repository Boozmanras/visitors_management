...
class UsersController extends Controller
{
    public function index()
    {
        ...
        return view('admin.users', ['users' => $users, 'roles' => $roles, 'users_roles' => $users_roles]);
    }
    ...
    public function edit($id) 
    {
        ...
        $reference = Crypt::encryptString($id);

        return view('admin.users-edit', ['user' => $user, 'roles' => $roles, 'reference' => $reference]); 
    }
    ...
    public function update(Request $request) 
    {
        ...
        $reference = Crypt::decryptString($request->reference);
        ...
        if ($password !== null && $password_confirmation !== null) 
        {
            ...
            table::users()->where('id', $reference)->update([
                'role_id' => $role_id,
                'status' => $status,
                'password' => Hash::make($password),
            ]);
