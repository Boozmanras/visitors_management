<!doctype html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="system-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('assets/') }}" data-template="vertical-menu-template">
<head>
    <meta charset="utf-8" />
